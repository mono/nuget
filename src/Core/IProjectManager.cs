...
namespace NuGet
{
    public interface IProjectManager
    {
        ...
        void AddPackageReference(string packageId, NuGetVersion version, bool ignoreDependencies, bool allowPrereleaseVersions);
        ...
        void UpdatePackageReference(string packageId, NuGetVersion version, bool updateDependencies, bool allowPrereleaseVersions);
        void UpdatePackageReference(string packageId, NuGetVersionRange versionRange, bool updateDependencies, bool allowPrereleaseVersions);
