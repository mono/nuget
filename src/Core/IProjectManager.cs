...
namespace NuGet
{
    public interface IProjectManager
    {
        ...
        void AddPackageReference(string packageId, ISemanticVersion version, bool ignoreDependencies, bool allowPrereleaseVersions);
        ...
        void UpdatePackageReference(string packageId, ISemanticVersion version, bool updateDependencies, bool allowPrereleaseVersions);
