...
namespace NuGet.VisualStudio
{
    ...
    public class VsPackageInstaller : IVsPackageInstaller
    {
        ...
        {
            InstallPackage(source, project, packageId, version == null ? (NuGetVersion)null : new NuGetVersion(version), ignoreDependencies);
        }
        ...
        internal void InstallPackage(string source, Project project, string packageId, NuGetVersion version, bool ignoreDependencies)
        {
        ...
        internal void InstallPackage(IPackageRepository repository, Project project, string packageId, NuGetVersion version, bool ignoreDependencies, bool skipAssemblyReferences)
        {
            if (project == null)
            {
        ...
        private static NuGetVersion ToSemanticVersion(string version)
        {
            return version == null ? (NuGetVersion)null : new NuGetVersion(version);
        }
    }
}
