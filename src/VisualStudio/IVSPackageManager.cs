...
namespace NuGet.VisualStudio
{
    public interface IVsPackageManager : IPackageManager
    {
        ...
        void InstallPackage(IProjectManager projectManager, string packageId, NuGetVersion version, bool ignoreDependencies, bool allowPrereleaseVersions, ILogger logger);
        void InstallPackage(IProjectManager projectManager, string packageId, NuGetVersion version, bool ignoreDependencies, bool allowPrereleaseVersions, bool skipAssemblyReferences, ILogger logger);
        ...
        // Uninstall
        void UninstallPackage(IProjectManager projectManager, string packageId, NuGetVersion version, bool forceRemove, bool removeDependencies);
        void UninstallPackage(IProjectManager projectManager, string packageId, NuGetVersion version, bool forceRemove, bool removeDependencies, ILogger logger);
        ...
        // Update one package
        void UpdatePackage(string packageId, NuGetVersion version, bool updateDependencies, bool allowPrereleaseVersions, ILogger logger, IPackageOperationEventListener eventListener);
        void UpdatePackage(string packageId, NuGetVersionRange versionRange, bool updateDependencies, bool allowPrereleaseVersions, ILogger logger, IPackageOperationEventListener eventListener);
        void UpdatePackage(IProjectManager projectManager, string packageId, NuGetVersion version, bool updateDependencies, bool allowPrereleaseVersions, ILogger logger);
