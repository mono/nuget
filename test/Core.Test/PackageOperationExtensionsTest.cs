                ...
                yield return new object[]
                {
                    ...
                    { 
                        ...
                        new PackageOperation(PackageUtility.CreatePackage("A.fr", "1.0", language: "fr",
                            dependencies: new[] { new PackageDependency("A", NuGetVersionRange.Parse("[1.0]")) }), PackageAction.Uninstall),
                        ...
                        new PackageOperation(PackageUtility.CreatePackage("A.fr", "1.2", language: "fr",
                            dependencies: new[] { new PackageDependency("A", NuGetVersionRange.Parse("[1.0]")) }), PackageAction.Install),
                    },
                    new [] 
                    { 
                        new PackageOperation(PackageUtility.CreatePackage("A.fr", "1.0", language: "fr",
