...
<packages>
  <package id=""A"" version=""1.0"" />
        ...
        public void AddPackageAddsEntryToPackagesConfigWithTargetFramework()
        {
            ...
            // Act
            referenceRepository.AddPackage("A", new NuGetVersion("1.0"), false, new FrameworkName("Silverlight, Version=2.0"));
...
<packages>
  <package id=""A"" version=""1.0"" targetFramework=""sl20"" />
        ...
        public void AddPackageAddsEntryToPackagesConfigWithDevelopmentDependency()
        {
            ...
            // Act
            referenceRepository.AddPackage("A", new NuGetVersion("1.0"), true, new FrameworkName("Silverlight, Version=2.0"));
...
<packages>
  ...
  <package id=""A"" version=""2.0-beta"" />
            ...
            // Assert
            Assert.True(result);
            Assert.Equal(new NuGetVersion("2.0-beta"), latestVersion);
        }
...
<packages>
  ...
  <package id=""A"" version=""2.0-beta"" />
            ...
            // Assert
            Assert.True(result);
            Assert.Equal(new NuGetVersion("2.0"), latestVersion);
        }
  ...
  <package id=""A"" version=""2.0-beta"" />
        ...
        <packages>
          ...
          <package id=""C"" version=""2.1.4"" />
            ...
            // Assert
            Assert.True(result);
            Assert.Equal(new NuGetVersion("2.5"), version);
        }
        ...
        <packages>
          ...
          <package id=""C"" version=""2.1.4"" />
            ...
            // Assert
            Assert.True(result);
            Assert.Equal(new NuGetVersion("2.5-beta"), version);
        }
        ...
        <packages>
          ...
          <package id=""C"" version=""2.1.4"" />
            ...
            // Assert
            Assert.True(result);
            Assert.Equal(new NuGetVersion("1.0"), version);
        }
