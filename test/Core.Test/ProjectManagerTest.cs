  ...
  <package id=""A"" version=""1.0"" />
        ...
        public void AddPackageReferenceShouldLeaveDependencyPackageAloneIfItSatisfiesTheVersionConstraint()
        {
            ...
            IPackage packageB = PackageUtility.CreatePackage(
               "B",
               "1.0",
               dependencies: new [] { new PackageDependency("A", NuGetVersionRange.Parse("1.1.0")) },
               assemblyReferences: new[] { "lib\\b.dll" });
        ...
        public void UpdatePackageReferenceShouldLeaveDependencyPackageAloneIfItSatisfiesTheVersionConstraint()
        {
            ...
            IPackage packageA2 = PackageUtility.CreatePackage(
                "A",
                "2.0.0",
                dependencies: new[] { new PackageDependency("B", NuGetVersionRange.Parse("1.0.0")) },
                assemblyReferences: new[] { "lib\\a2.dll" });
        ...
        public void DowngradeDependencyPackagesWhenParentPackagesIsDowngraded()
        {
            ...
            IPackage packageA20 = PackageUtility.CreatePackage("A", "2.0",
                                                                dependencies: new List<PackageDependency> { 
                                                                    new PackageDependency("B", NuGetVersionRange.Parse("2.0"))
                                                                }, content: new[] { "foo" });
            IPackage packageB10 = PackageUtility.CreatePackage("B", "1.0", content: new[] { "foo" });
...
".AsStream());
        ...
        public void UpdatePackageHasNoEffectIfConstraintsDefinedDontAllowForUpdates()
        {
            ...
            constraintProvider.Setup(m => m.GetConstraint("A")).Returns(NuGetVersionRange.Parse("[1.0, 2.0)"));
        ...
        [Fact]
        public void UpdatePackageReferenceNoVersionRangeifiedShouldUpdateToLatest()
        {
            // Arrange
            var sourceRepository = new MockPackageRepository();
            var projectSystem = new MockProjectSystem();
        ...
        [Fact]
        public void UpdatePackageReferenceVersionRangeiedShouldUpdateToSpecifiedVersion()
        {
            // Arrange
            var sourceRepository = new MockPackageRepository();
            var projectSystem = new MockProjectSystem();
